...
if __name__ == "__main__":
    ...
    parser.add_argument("--preserve-output-files", action="store_true", help="If set, RTH will not delete the temporary stdout and stderr files of the child process.")
